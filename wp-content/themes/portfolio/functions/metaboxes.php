...
function mts_inner_sidebar_metabox($post) {
    ...
    */
    ...
    $hidden_sidebars = array('sidebar','shop-sidebar', 'product-sidebar', 'footer-top', 'footer-top-2', 'footer-top-3', 'footer-top-4', 'footer-bottom', 'footer-bottom-2', 'footer-bottom-3', 'footer-bottom-4');    
